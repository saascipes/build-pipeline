...
class BaseLogger {
    constructor(appName) {
        ...
        this.appLoggingLevel = null;
        this.defaultLoggingLevel = Enums_js_1.LogLevel.DEBUG;
        this.pruneLogsInterval = 65000; // 65 seconds
        this.cycleCacheInterval = 30000; // 30 seconds
        this.maxAggregateLogSize = 5242880; // 5 MB
        this.lockCache = new AsyncLock();
        this.lockCacheKey = 'lock_cache_key';
        this.readyToWrite = false;
        this.stopped = false;
        this.logsPath = 'logs';
        this.ipAddress = getIpAddress();
        this.machineId = os.hostname();
        this.appLoggingLevel = Enums_js_1.LogLevel.DEBUG;
    ...
    async UploadLogFile(filePath, fileSize) {
        try {
    ...
    async LogError(msg, values) {
        await this.Log(Object.assign({ 'msg': msg }, values), Enums_js_1.LogLevel.ERROR);
    }
    async LogWarning(msg, values) {
        await this.Log(Object.assign({ 'msg': msg }, values), Enums_js_1.LogLevel.WARNING);
    }
    async LogInfo(msg, values) {
        await this.Log(Object.assign({ 'msg': msg }, values), Enums_js_1.LogLevel.INFO);
    }
    async LogDebug(msg, values) {
        await this.Log(Object.assign({ 'msg': msg }, values), Enums_js_1.LogLevel.DEBUG);
    }
}
exports.BaseLogger = BaseLogger;
//# sourceMappingURL=SGLogger.js.map